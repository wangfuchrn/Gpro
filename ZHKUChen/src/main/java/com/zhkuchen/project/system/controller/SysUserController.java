...
/**
 * 用户信息 在控制层Controller中添加注解来描述接口信息如
 * 
 */
@RestController
...
public class SysUserController extends BaseController
{
     ...
     * 根据用户手机号获取用户id
     */
    @GetMapping(value = "getuserId/{phoneNumber}")
    public AjaxResult getuserIdByPhoneNumber(@PathVariable String phoneNumber)
    {
        return AjaxResult.success(userService.selectUserByUserPhoneNumber(phoneNumber));
    }
    ...
    {
        return AjaxResult.success(userService.getUserNameByUserId(userId));
    }

...
export const messageWarn = (obj, message) => {
  obj.$message({ message: message, type: 'warning', offset: 90 })
}
...
export const messageSuccess = (obj, message) => {
  obj.$message({ message: message, type: 'success', offset: 90 })
}
...
export const messageFail = (obj, message) => {
  obj.$message({ message: message, type: 'error', offset: 90 })
}
...
<script>
    ...
    import { choiceslistExamSubjects, removeExamSubjectById } from  "@/api/assess/examManage";
    ...
    export default {
        ...
        methods: {
            ...
            getList() {
                ...
                //通过examinationID获取题目列表信息
                choiceslistExamSubjects(this.examinationId).then(response => {
                        ...
                        if (this.form.id != undefined) {
                          ...
                          if(this.form.type===3){
                            ...
                            choicesaddSubject(this.form).then(response => {
                                // for(var i=0;i<this.form.optionsId.length;i++){
                                //   console.log(this.form.optionsId[i]);
                                //   choiceOptionsaddSubject(this.form.optionsId[i]);
                                // }
                                if (response.code === 200) {

  ...
  <div id="entry" class="main">
          ...
          <div class="main-menu">
            <ul class="clearfix">
              ...
              <li class="skip menu-item">
                <p style="font-size:16px;">我是个人用户，请<router-link class="skiplink" index="1" tag="li" to="/ordinaryUser/login">点击这里</router-link></p>
              </li>      
            </ul>
          </div>
        </div>
    ...
    <div class="content">
      <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form">
        ...
        <!-- <router-link class="forget" index="1" tag="li" to="/user/login" >忘记密码?</router-link> -->
        <el-form-item style="width:100%;">
          <el-button
            type="primary"
            size="medium"
            style="width:100%;"
            ><router-link index="1" tag="li" to="/ordinaryUser/login" style="list-style:none;">注 册</router-link>
          </el-button>
          <!-- <el-button
            :loading="loading"
            size="medium"
